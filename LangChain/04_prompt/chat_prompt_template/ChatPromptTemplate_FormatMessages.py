...
chat_prompt = ChatPromptTemplate.from_messages(#用from_messages方法获得chat提示模板,
    # 方法是下面format_messages方法获得提示词
    [
...
prompt_value = chat_prompt.format_messages(**{"role": "python开发工程师",
                                              "question": "堆排序怎么写"})#解包
#ef format_messages(self, **kwargs: Any) -> list[BaseMessage]:  两个星星代表dict字典类型KV键值对
# 打印格式化后的提示消息
print(prompt_value)
